...
def using_secret_formula():
    ...
    print(f"The new starting point is {start_point}")
    formula = secret_formula(start_point)
    # this is an easy way to apply a list to a format string
    print("We'd have {} beans, {} jars, and {} crates.".format(*formula))


def cat_and_dog_comparison():
    people = 20
    cats = 30
    dogs = 15
...
if __name__ == '__main__':
    ...
    read_a_file_from_user()
    printing_practice()
    using_secret_formula()
    cat_and_dog_comparison()